...
``` {r 613_hw2_2c}
Ten_Thousand_Five <- numeric(10000)
Ten_Thousand_Ten <- numeric(10000)
Ten_Thousand_Twenty <- numeric(10000)

for (i in 1:10000){
  Ten_Thousand_Five[i] <- mean(rexp(5, rate = 1))
  Ten_Thousand_Ten[i] <- mean(rexp(10, rate = 1))
  Ten_Thousand_Twenty[i] <- mean(rexp(20, rate = 1))
